            ...
            <div class="row justify-content-between">
                <div class="col-xl-3 col-lg-3 col-md-5">
                    <div class="h6_footer-widget mb-40 mr-80">
                        <div class="footer-logo">
                            <a href="index.html"><img src="assets/img/logo/logo-violet.png" alt=""></a>
                        </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-5">
                    <div class="h6_footer-widget ml-80 mb-40">
                        ...
                        <p class="h6_footer-widget-text newsletter-text">Sign up foe our newsletter and get 34% <br> off
                            your next course.</p>
                        <form action="#">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="h6_copyright-text">
                        <p>Copyright © 2023 - {{ date('Y') }} All Rights Reserved by {{ env('APP_NAME') }}</p>
                    </div>
                </div>
            </div>
        </div>
